...
console.log('The length is = '+ s1.lenght);
...
// Get the middle character of the string which has odd length

let s2 = 'Victoria';
console.log([(s2.length - 1) / 2]);
...
console.log(s9.length - s9.replaceAll(' ', '').length + 1); //number of words = number of spaces + 1
...
let s7 = "red";
let char = "xx"
console.log(s7.startsWith(char) && s7.endsWith(char));

let s7 = "xxredxx";
let char = "xx"
console.log(s7.startsWith(char[0, 2]) && s7.endsWith(char[- 2]));
console.log(s7.startsWith(s7.slice(0, 2)) && s7.endsWith(s7.slice(s7.length - 2)));
