...
const booksProto = [book1, book2, book3]

const authorProto = new Author('George R. R','Martin','United States', booksProto);

console.log(authorProto.getFullName());
...
//
authorProto.getBooks().forEach(book => console.log(book));
