...
-Create a method called as superAttack() which takes a player object as argument and increases the attacking player's score by 2 while it decreases the attacked player's score by 2
*/
...
function HeroPlayer1(nickName, score) {
    Player1.call(this, nickName, score);
}
...
const player3 = new Player1('Player 1', 5);
const player4 = new Player1('Player 2', 5);
