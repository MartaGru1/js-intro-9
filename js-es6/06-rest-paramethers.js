// Rest parameters allow us to create a method that can take any number of parameters.
...
function favActs(top, ...rest) {
    console.log('Top activity is ',top);
    if(rest.length > 0) {
...
favActs('Codind', 'Reading', 'Biking', 'Playing PS5');
