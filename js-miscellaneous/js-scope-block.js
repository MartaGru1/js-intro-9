...
// a, b, and c are block scoped. So, they are not accessible outside the block.

console.log(a); // ReferenceError: a is not defined
console.log(b); // 1 - worked because var is function scoped, and does not support block scope
