...
// Count how many numbers are 50 or more -> 4

console.log(numbers.filter(number => number >= 50).length);
...
console.log(fruits.filter(x => x.toLowerCase().includes('i')).length);   // 2
