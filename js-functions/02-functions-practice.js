/*
Create a function named as sayHi which output "Hi" to the consoe when inwoken
*/
function sayHi(){
...
/*
Write a function named as sayHello which takes the name(string) and output "Hello,(name)!"
...
greetPeople('Hello', 'John'); // Hello, John!
